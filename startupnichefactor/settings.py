"""
Django settings for startupnichefactor project.
...
ROOT_URLCONF = 'startupnichefactor.urls'
...
WSGI_APPLICATION = 'startupnichefactor.wsgi.application'
...
CORS_ALLOWED_ORIGINS = ["http://localhost:3000", "https://startupnichefactor.com"]
